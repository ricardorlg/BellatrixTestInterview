...
import com.example.bellatrix.interview.ricardo.ui.SearchBox;
...
public class Search implements Task {
	...
	@Step("{0} Searchs for #searchTerm")
	public <T extends Actor> void performAs(T actor) {
		actor.attemptsTo(Enter.theValue(searchTerm).into(SearchBox.SEARCH_FIELD).thenHit(ENTER));
	}
